...
⚠️ **DO NOT EDIT THIS FILE** if you are an Owner, Worker, or Feature chat.
Methodology files are maintained by the EP meta-session only.
If you found a process problem, flag it as `Methodology candidate:` in your
closing report to the Owner. The EP will integrate it. Do not write here.
